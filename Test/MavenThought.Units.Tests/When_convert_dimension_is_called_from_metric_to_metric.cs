...
namespace MavenThought.Units.Tests
{
    ...
    /// </summary>
    [Specification]
    public class When_convert_dimension_is_called_from_metric_to_metric : UnitExtensionsSpecification
    {
        /// <summary>
        ...
        [Row(1)]
        [Row(2)]
        public When_convert_dimension_is_called_from_metric_to_metric(int index)
        {
        ...
        {
            Assert.AreEqual(this.ExpectedDimension.FromMeters(this.Input.Quantity), this.Actual.Quantity);
        }
